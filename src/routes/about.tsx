  ...
  return (
    <>
      <PageHero
        eyebrow="About us"
        title={company.since}
        intro="One in-house team for structure, finishing, procurement and site management."
        image={img.courtyard}
      />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-[1.15fr_1fr] lg:px-8">
          <div>
            ...
            <div className="mt-8">
              <Prose>
                <p>
                  Rehman Construction & Enterprises is a full-service construction company operating across Islamabad
                  and Rawalpindi. We take a plot, a drawing or a half-built shell — and hand back a finished building on
                  an agreed number and an agreed date.
                </p>
                <p>
                  No subcontracted confusion, no hidden variations. Our own supervisors run the site, our own quality
                  checks sign off every pour, and the client sees the same rate sheet we work from.
                </p>
                <p>
                  From grey structure to the last coat of paint, we build in one contract with one supervisor —
          ...
          <Reveal>
            <div className="lit-panel overflow-hidden bg-card">
              <img
                src={img.luxuryVilla}
                alt="Completed luxury villa by Rehman Construction & Enterprises"
                loading="lazy"
